      ...
      <div class="main-inner-content">
        ...
        <div class="video-elem">
          ...
          <div class="elem-fixed-widht interract-buttons-holder" >
            ...
            <input type="button" class="interract-button" onclick="toGetComment(<?php echo $all_links[$id][0]?>)" value="коментарий">
            <input type="button" class="interract-button" onclick="todeleteData(event, <?php echo $all_links[$id][0] ?>, 'link')" value="удалить">
