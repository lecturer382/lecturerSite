...
<html lang="en"> 
  <head>
    ...
    <title>Выгруженные презентации</title>
    <link
      rel="stylesheet"
      href="../../styles/uploadet_data_styles/uploaded_materials.css"
    />
    <script src='../../JS/presentations/uploaded-presentations.js' defer>
    </script>
    ...
    <?php
      ...
      $all_presentations = mysqli_query($connect, "SELECT * FROM `presentations`");
      ...
      <div class="main-inner-content">
        ...
        <div class="video-elem">
          ...
          <div class="elem-fixed-widht interract-buttons-holder" >
            ...
            <input type="button" class="interract-button" onclick="todeleteData(event, <?php echo $all_presentations[$id][0] ?>, 'presentations')" value="удалить">
